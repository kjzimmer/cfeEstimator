      ...
      {active && (
        <div className="bg-surface border border-border rounded-lg p-6">
          ...
          <textarea
            ...
            rows={16}
            className="w-full rounded-md border border-border bg-bg px-3 py-2 text-sm text-text font-mono leading-relaxed focus:outline-none focus:ring-2 focus:ring-accent/40 focus:border-accent resize-y"
          />
